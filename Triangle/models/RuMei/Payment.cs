...
namespace Triangle.models
{
    public class Payment
    {
       ...
       string is_archived, String payment_date, int supplier_id, int invoice_id, int update_history_id, string payment_method, bool is_received, bool is_approved, bool is_declined)
        ...
        public Payment(string description, decimal total_price, string bank_name,
           string bank_number, string bank_branch, string card_name, string card_number, string expiry_date,
            string payment_date, int invoide_id, string payment_method)
            : this(null, description, total_price, bank_name, bank_number, bank_branch, card_name, card_number, expiry_date, "False", payment_date, 1, invoide_id, 1, payment_method, false, true, false)
        {
        ...
        public int PaymentInsert(string description, decimal total_price, string bank_name, string bank_number, string bank_branch, string card_name, string card_number, string expiry_date, string payment_date, int invoice_id, string payment_method)
        {
            //tb_description.Text, decimal.Parse(tb_totalprice.Text), tb_bankname.Text, tb_banknumber.Text, tb_bankbranch.Text, tb_cardname.Text, tb_cardnumber.Text, tb_expirydate.Text, (tb_paymentdate.Text), id, tb_paymentmethod.Text
            int result = 0;
            string queryStr = "INSERT INTO [payments](description, total_price, bank_name, bank_number, bank_branch, card_name, card_number, expiry_date, payment_date, payment_method, supplier_id, invoice_id, update_history_id)"
                + "values(@description, @total_price, @bank_name, @bank_number, @bank_branch, @card_name, @card_number, @expiry_date, @payment_date,@payment_method, @supplier_id, @invoice_id, @update_history_id)";
            SqlConnection conn = new SqlConnection(_connStr);
            SqlCommand cmd = new SqlCommand(queryStr, conn);
            cmd.Parameters.AddWithValue("@description", description);
            cmd.Parameters.AddWithValue("@total_price", total_price);
            cmd.Parameters.AddWithValue("@bank_name", bank_name);
            cmd.Parameters.AddWithValue("@bank_number", bank_number);
            ...
            cmd.Parameters.AddWithValue("@expiry_date", expiry_date);
            //cmd.Parameters.AddWithValue("@is_archived", is_archived);
            cmd.Parameters.AddWithValue("@payment_date", payment_date);
            cmd.Parameters.AddWithValue("@payment_method", payment_method);
            cmd.Parameters.AddWithValue("@supplier_id", 1);
            cmd.Parameters.AddWithValue("@invoice_id", invoice_id);
            cmd.Parameters.AddWithValue("@update_history_id", 1);
