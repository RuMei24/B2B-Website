...
namespace Triangle.w.Admin.Finance
{
    public partial class ViewPayment : System.Web.UI.Page
    {
        ...
        protected void gv_Payment_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (result > 0)
            {
                ScriptManager.RegisterStartupScript
                   (this, this.GetType(),
                   "alert",
                   "alert('Product has been successfully deleted');window.location = 'ViewPayment.aspx';",
                   true);
        ...
        {
            if (rb_sort.SelectedValue == "Price(Highest to Lowest)")
            {
                List<Payment> filterlist = new List<Payment>();
        ...
        protected void btn_archivedata_Click(object sender, EventArgs e)
        {
