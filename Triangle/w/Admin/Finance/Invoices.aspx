...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div class="row no-gutters justify-content-center mt-4">
        <div class="col-md-12">
            ...
            <asp:GridView ID="gvInvoice" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" AllowPaging="True" DataKeyNames="invoice_id" OnSelectedIndexChanged="gvInvoice_SelectedIndexChanged" OnRowDeleting="gvInvoice_RowDeleting">
            <Columns>
                ...
                <asp:CommandField DeleteText="Make Payment" ShowDeleteButton="True" />
            </Columns>
        </asp:GridView>
        </div>
    </div>
