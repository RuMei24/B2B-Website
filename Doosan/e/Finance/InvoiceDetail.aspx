            ...
            <asp:GridView ID="gv_InvoiceView" runat="server" AutoGenerateColumns="False" EmptyDataText="There is nothing in your invoice." CssClass="table table-bordered table-striped">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Product">
                        <ItemTemplate>
                            <asp:Image ID="product_image" runat="server" Width="100px" Height="100px" CssClass="prod_img" ImageUrl='<%# "data:Image/png;base64,"+ Convert.ToBase64String((byte[])Eval("product_image")) %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
